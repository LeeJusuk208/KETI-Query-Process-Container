...
::grpc::ClientReaderWriter< ::snippetsample::Snippet, ::snippetsample::Result>* SnippetSample::Stub::SetSnippetRaw(::grpc::ClientContext* context) {
  return ::grpc::internal::ClientReaderWriterFactory< ::snippetsample::Snippet, ::snippetsample::Result>::Create(channel_.get(), rpcmethod_SetSnippet_, context);
}

void SnippetSample::Stub::async::SetSnippet(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::snippetsample::Snippet,::snippetsample::Result>* reactor) {
  ::grpc::internal::ClientCallbackReaderWriterFactory< ::snippetsample::Snippet,::snippetsample::Result>::Create(stub_->channel_.get(), stub_->rpcmethod_SetSnippet_, context, reactor);
}

::grpc::ClientAsyncReaderWriter< ::snippetsample::Snippet, ::snippetsample::Result>* SnippetSample::Stub::AsyncSetSnippetRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::snippetsample::Snippet, ::snippetsample::Result>::Create(channel_.get(), cq, rpcmethod_SetSnippet_, context, true, tag);
}

::grpc::ClientAsyncReaderWriter< ::snippetsample::Snippet, ::snippetsample::Result>* SnippetSample::Stub::PrepareAsyncSetSnippetRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::snippetsample::Snippet, ::snippetsample::Result>::Create(channel_.get(), cq, rpcmethod_SetSnippet_, context, false, nullptr);
}
...
SnippetSample::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::BidiStreamingHandler< SnippetSample::Service, ::snippetsample::Snippet, ::snippetsample::Result>(
          [](SnippetSample::Service* service,
...
::grpc::Status SnippetSample::Service::SetSnippet(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::snippetsample::Result, ::snippetsample::Snippet>* stream) {
  (void) context;
  (void) stream;
